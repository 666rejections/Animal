local Keys = {
    ...
    ["~"] = 243, ["1"] = 157, ["2"] = 158, ["3"] = 160, ["4"] = 164, ["5"] = 165, ["6"] = 159, ["7"] = 161, ["8"] = 162, ["9"] = 163, ["-"] = 84, ["F11"] = 344, ["BACKSPACE"] = 177,
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(1)
		if IsControlPressed(0, Keys['F11']) and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'eden_animal') and (GetGameTimer() - GUI.Time) > 150 then
            OpenAnimal()
